class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {}, 𝗜'𝗠 𝗦𝗨𝗣𝗘𝗥𝗠𝗔𝗡. 𝗧𝘆𝗽𝗲 𝗮𝗻𝘆 𝗠𝗼𝘃𝗶𝗲 𝗡𝗮𝗺𝗲 𝗔𝗻𝗱 𝗦𝗲𝗲 𝗠𝗮𝗴𝗶𝗰
    𝙏𝙤 𝙐𝙨𝙚 𝙩𝙝𝙞𝙨 𝙗𝙤𝙩 𝙮𝙤𝙪 𝙣𝙚𝙚𝙙 𝙩𝙤 𝙫𝙚𝙧𝙞𝙛𝙮, 𝘼𝙛𝙩𝙚𝙧 𝙫𝙚𝙧𝙞𝙛𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝙮𝙤𝙪 𝙝𝙖𝙫𝙚 𝙪𝙣𝙡𝙞𝙢𝙞𝙩𝙚𝙙 𝙖𝙘𝙘𝙚𝙨𝙨. 
𝗛𝗼𝘄 𝗧𝗼 𝗩𝗲𝗿𝘆𝗶𝗳𝘆👇
<a href=https://youtube.com/shorts/iZLpKqW88v4?si=qd-pS6E59iP5MYbc/67>☞ᴄʟɪᴄᴋ ʜᴇʀᴇ☜</a>

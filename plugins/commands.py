...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Movies Gʀᴏᴜᴘ🛑', url=""),
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/+mjs1xYh3aXQ5YTI9')
                ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton("Mᴏᴠɪᴇ Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="https://t.me/+mhOTAcVukpIwZmI1")
                            ],
                            [
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply("<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nयह मूवी फ़ाइल/वीडियो 10 मिनट में डिलेट हो जाएगी 🫥 <i></b>(Due to Copyright Issues)</i>.\n\nThis Movie Files/Videos will be deleted in <b><u>10 mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>\n\n<b><i>कृपया इस फ़ाइल/वीडियो को अपने सेव मैसेज या किसी चैट में फॉरवर्ड कर ले और वहां डाउनलोड चालू करें\n\nPlease forward this file/video to your save message or any chat and start download there</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
    ...
    files = files_[0]
    title = '@Filmycloud_Movies  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))

...
BOT_TOKEN = environ.get('BOT_TOKEN', "6495773759:AAHMKNEGwjST3UApSCyByXnU8bTxK1l083E")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001818522365')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = [environ.get('DATABASE_URI', "mongodb+srv://Selfmixbot:nehalsingh969797@cluster0.kb5xjos.mongodb.net/?retryWrites=true&w=majority , mongodb+srv://Filestorestream:nehalsingh969797@cluster0.j6t2r2n.mongodb.net/?retryWrites=true&w=majority").split()] 
